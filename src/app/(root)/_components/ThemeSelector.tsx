...
import {THEMES} from "@/app/(root)/_constants";
import {AnimatePresence, motion} from 'framer-motion';
import {CircleOff,Palette,Moon,Sun,Github,Laptop,Cloud} from "lucide-react";
    ...
    return (
        <div className='relative' ref={dropdownRef}>
            <motion.button
                ...
                className="w-48 group relative flex items-center gap-2 py-2.5 px-2 bg-[#1e1e2e]/80 hover:bg-[#262637]
            ...
            >
                ...
                <span className="text-gray-300 min-w-[80px] text-left group-hover:text-white transition-colors">{currentTheme?.label}
                </span>
